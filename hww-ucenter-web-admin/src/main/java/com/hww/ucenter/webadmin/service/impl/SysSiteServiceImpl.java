...
//				hql.append(" and siteName like :siteNameP").setParam("siteNameP", "%" + searchDto.getSiteName() + "%");
//			}
//			if (StringUtils.isNotBlank(searchDto.getDomain())) {
//				hql.append(" and domain=:domainP").setParam("domainP", searchDto.getDomain());
//			}
...
//			List<SysSiteDto> siteDtoList = BeanMapper.mapList(p.getList(), SysSiteDto.class);
