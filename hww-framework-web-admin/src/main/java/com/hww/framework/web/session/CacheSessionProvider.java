package com.hww.framework.web.session;
...
import com.hww.framework.web.session.cache.SessionCache;
import com.hww.framework.web.session.id.SessionIdGenerator;
import com.hww.framework.web.util.RequestUtils;
...
public class CacheSessionProvider implements SessionProvider, InitializingBean {
	...
	public void afterPropertiesSet() throws Exception {
		Assert.notNull(sessionCache,"not null");
		Assert.notNull(sessionIdGenerator,"not null");
	}
	...
	public void setSessionTimeout(int sessionTimeout) {
		Assert.isTrue(sessionTimeout > 0,"less than 0 is wrong");
