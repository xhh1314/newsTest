...
//import com.hww.els.common.entity.Article;
...
//	 * @return
//	 */
//	public ElasticSearchPage<Article> searchFullText(Article param, ElasticSearchPage<Article> page,
//			HighlightBuilder highlight, String indexs) {
//		QueryBuilder builder = null;
//		Map<String, Object> map = getObjectMap(param);
//		if (map == null)
//			return null;
...
//		boolean b;
//		try {
//			b = client.admin().indices().prepareTypesExists(index).setTypes(type).execute().actionGet().isExists();
//		} catch (Exception e) {
//			e.printStackTrace();
//			return false;
//		}
...
//											.setIndex(index)
//											.setType(type)
//											.setId(map.get("id").toString()) // 如果没有设置id，则ES会自动生成一个id
