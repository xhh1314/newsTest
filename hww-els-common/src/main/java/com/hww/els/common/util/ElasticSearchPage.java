...
//
//    private List<Map<String, Object>> mapResList;
//
...
//        return "Page{" + "scrollId='" + scrollId + '\'' + ",total=" + total + ",pageSize=" + pageSize + ",pageNum="
//                + pageNum + ",param=" + param + ",retList=" + retList + ",scrollIds=" + scrollIds + '}';
//    }
//
//    public List<Map<String, Object>> getMapResList() {
//        return mapResList;
//    }
//
//    public void setMapResList(List<Map<String, Object>> mapResList) {
//        this.mapResList = mapResList;
//    }
//}
