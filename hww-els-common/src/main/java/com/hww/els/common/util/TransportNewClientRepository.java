...
//import com.hww.els.common.entity.New;
...
//import java.util.*;
//
//public class TransportNewClientRepository {
//
//	private static final Logger log = LoggerFactory
//			.getLogger(TransportNewClientRepository.class);
//
//	private TransportClient client;
//
//	public TransportNewClientRepository(TransportClient client) {
//		try {
//			this.client = client;
//		} catch (Exception e) {
//			e.printStackTrace();
...
//	 * @return
//	 */
//	public ElasticSearchPage<New> searchFullText(New param,
//			ElasticSearchPage<New> page, HighlightBuilder highlight,
//			String indexs) {
//		QueryBuilder builder = null;
//		Map<String, Object> map = getObjectMap(param);
//		if (map == null) {
