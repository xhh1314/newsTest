...
import com.hww.sns.webadmin.security.MyShiroFilterFactoryBean;
import com.hww.sns.webadmin.security.UserRealm;
...
public class ShiroConfig {
	...
	public CasFilter casFilter(){
		...
		//casFilter.setFilterConfig(filterConfig);
