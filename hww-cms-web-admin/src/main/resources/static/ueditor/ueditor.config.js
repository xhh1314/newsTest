...
var API_DOMAIN = "http://api.haiwainet.cn/api-file/";
//var API_DOMAIN = "http://127.0.0.1:7810/";
/**************************提示********************************
...
(function () {
  ...
  window.UEDITOR_CONFIG = {
    ...
    , toolbars: [[
      ...
      /*'simpleupload',*/ 'insertimage', 'emotion', 'scrawl' , /*'attachment',*/ 'map', 'insertframe', 'insertcode', '|',
      'horizontal', 'date', 'time', 'spechars', 'snapscreen', 'wordimage', '|',
      'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', 'charts', '|',
      'print', 'preview', 'searchreplace', 'drafts',/* 'fullscreen',*/ 'source', '|', 'undo', 'redo'
    ]]
    // , toolbars: [[
