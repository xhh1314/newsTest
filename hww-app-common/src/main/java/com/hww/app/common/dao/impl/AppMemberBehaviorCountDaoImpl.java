...
@Repository
public class AppMemberBehaviorCountDaoImpl extends LocalEntityDaoImpl<Long, AppMemberBehaviorCount> implements AppMemberBehaviorCountDao {
...
//	@Override
//	public List<AppMemberBehaviorCount> loadByContentIdsAndBevType(List<Long> contentIds, Integer bevType,Integer plateType) {
//		Finder f = Finder.create("from AppMemberBehaviorCount bean");
